...
/** @brief class definition for deterministic crowding genetic algorithm
This is the class definition for the deterministic crowding genetic algorithm.
It is based upon the steady-state genetic algorithm, but we modify the replacement
so that it does deterministic crowding as described by Goldberg (not in his book) and his students.
*/
...
/****************************************************************************Type:        2D FUNCTION                                                  Name:        Objective2D_1                                                 2D tooth                                                     Boundaries:  -6 < x < 6                                                                -6 < y < 6                                                   Source:      modified Himmelblau's function from Deb, K.                               'GA in multimodal function optimazation' Masters thesis      */
...
/****************************************************************************Type:        2D FUNCTION                                                  Name:        Objective2D_2                                                 Foxholes (25)                                                Boundaries:  -60 < x < 60                                                              -60 < y < 60                                                 Source:      Shekel's Foxholes problem from De Jong's Diss.(1975)                      'GA in multimodal function optimazation' Masters thesis      */
/**		TCGA Rep. 89002 / U. of Alabama                              ***************************************************************************/
float
...
/****************************************************************************Type:        2D FUNCTION                                                  Name:        Objective2D_3                                                 Schwefel's nasty (1 glob. Max bei (420.96/420.96)            Boundaries:  -500 < x < 500                                                            -500 < y < 500                                               Source:      Schwefel's function in Schoeneburg                           ***************************************************************************/
float
...
/****************************************************************************Type:        2D FUNCTION                                                  Name:        Objective2D_4                                                 Mexican Hat                                                  Boundaries:  -10 < x < 10                                                              -10 < y < 10                                                 Source:                                                                   ***************************************************************************/
float
