...
/** constructor*/
template <> 
GA1DArrayAlleleGenome<char>::GA1DArrayAlleleGenome(const GAAlleleSetArray<char> & sa,
                                                    GAGenome::Evaluator f, void * u) :
...
/// @brief force instantiations of this genome type.
/// These must be included @b after the specializations because some compilers
