...
/// This enforces return values and arguments to functions that want strict boolean arguments.
...
/// This defines what type to use for the bitstream data storage.  
/// Use the smallest type available on your platform.
