...
/** @brief GAList, container for nodes that have a list structure.
...
/** @brief GAListIter, a type-safe derivation of the base ListIter object. 
...
public:
    ...
    GAListIter(const GAList<T> & t) : GAListIterBASE(t)
    {
        node = t.iter.node;
    }
