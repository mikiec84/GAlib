...
crossover, evaluate, etc.  

When you create your own genome, multiply inherit from the base genome class and the data type that you want to use.  
Use the data type to store the information, and use the genome part to tell the GA how
...
/** @brief Genome.
 ...
 @li Deriving your own genomes: <br>
